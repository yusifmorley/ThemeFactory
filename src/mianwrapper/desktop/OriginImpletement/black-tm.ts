...
export default async function black_theme(colorArray,bgbase64,flag:boolean,str2="") {
    ...
    primaryBG = colorArray[0];
    primaryBG2 = '#000000';
    primaryBG3 = colorArray[2];
    primaryBG4 = '#000000';
    primaryBG4Trans = '#000000';
    primaryBG5 = '#000000';
    primaryBG6 = '#000000';
    primaryText = '#000000';
    primaryText2 = colorArray[1];
    let Palette = "// Generated by Telegram Theme Generator v3.0, by Night Apps \n // Try it out at https://nightapps.github.io/td-gen \n  \n //Define Night Color Scheme v3.0 \n nightBlue: #0054aa; \n nightBlueDark: #002a55; \n nightRed: #aa1400; \n nightRedDark: #550a00; \n nightOrange: #d15900; \n nightOrangeDark: #682c00; \n nightYellow: #d1bb00; \n nightYellowDark: #685d00; \n nightGreen: #24aa00; \n nightGreenDark: #125500; \n nightAqua: #00a0aa; \n nightAquaDark: #005055; \n nightViolet: #7800aa; \n nightVioletDark: #3c0055; \n nightPink: #d100b1; \n nightPinkDark: #680058; \n";
    let primaryColorDark = ColorLuminance(primaryColor, -0.5);
    let primaryColorTrans = primaryColor + '80';
    let primaryDark80=primaryBG+'80'
    let primaryDark4c=primaryBG+'4c'
    Palette = Palette + '//Background \n primaryDark: ' + colorArray[0]  //主背景颜色
        + '; \n secondaryDark: ' + primaryBG2 +   //
        '; \n tertiaryDark: ' + primaryBG3 +   // 鼠标 hover 激活 颜色  搜索框未选中颜色 颜色
        '; \n quaternaryDark: ' + primaryBG4 + // 聊天界面背景色
        '; \n quaternaryDarkTrans: ' + primaryBG4Trans + //
        '; // manually defined \n quinaryDark: ' + primaryBG5 + //
        '; \n senaryDark: ' + primaryBG6 +   //搜索框 选中颜色
        '; \n //Colors \n primaryColor: ' + primaryColor + //鼠标选择
        '; \n primaryColorDark: ' + primaryColorDark + //
        '; \n primaryColorTrans: ' + primaryColorTrans +
        '; // manually defined \n //Text \n primaryText: ' + primaryText + //小圆圈字体 选中图标颜色 聊天列表 主名称颜色
        '; \n secondaryText: ' + primaryText2 + '; \n\n'; // sidebar 未选中图标颜色 聊天列表 主名称颜色

    Palette = Palette +
        `windowBg: primaryDark; // white: fallback for background
 windowFg: secondaryText; // 聊天界面 字体颜色
 ...
 windowBoldFg: secondaryText; // 个人信息页把字体颜色
 ...
 scrollBgOver: #00000024; // default scroll bar background with mouse over the scroll bar
 ...
 filterInputInactiveBg: secondaryText; // default rounded input field background (like in chats list search field when field is inactive)
 ...
 trayCounterFgMacInvert: #00000001; // tray icon counter text when tray icon is pressed or when dark theme of macOS is used (macOS only)
 ...
 photoCropPointFg: #0000007f; // avatar crop box corner rectangles (when choosing a new photo in Settings or for a group)
 ...
 dialogsDateFg: secondaryText; // chat list date text
 dialogsTextFg: secondaryText; // chat list message text
 ...
 dialogsUnreadBgMuted: tertiaryDark; // chat list unread badge background for muted chat
 dialogsUnreadFg: primaryText; // chat list unread badge text
 dialogsBgOver: tertiaryDark; // chat list background with mouse over
 dialogsNameFgOver: #000000; // chat list name text with mouse over
 dialogsChatIconFgOver: dialogsNameFgOver; // chat list group or channel icon with mouse over
 dialogsDateFgOver: #000000; // chat list date text with mouse over
 dialogsTextFgOver: #000000; // chat list message text with mouse over
 ...
 dialogsBgActive: tertiaryDark; // chat list background for current (active) chat
 ...
 dialogsSendingIconFgActive: #00000099; // chat list sending message icon (clock) for current (active) chat
 ...
 emojiPanHeaderBg: #000000f2; // emoji panel section header background
 ...
 historySendingInvertedIconFg: #000000c8; // media sending message icon (clock) (like in sent photo)
 ...
 msgBotKbOverBgAdd: #00000014; // this is painted over a bot inline keyboard button (which has msgServiceBg background) when mouse is over that button
 ...
 mediaviewPlaybackProgressFg: #000000c7; // video playback progress text
...
`;
    ...
    if (background) {
        zip.file("background.png", background, {
            base64: true
        });
    }
...
function convertToHex(num) {
    ...
    num = num.toString(16);
    const result = num.toUpperCase();
    return result;
}

function convertToDec(num) {
    const isNegative = num.toString().toLowerCase().substring(0, 2) === 'ff';
    num = parseInt(num, 16);
