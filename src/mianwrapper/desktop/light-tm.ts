...
export default async function light_theme(colorArray,bgbase64,flag:boolean,str2="") {
...
`windowBg: primaryDark; // white: fallback for background
 ...
 dialogsNameFgOver: #ffffff; // chat list name text with mouse over
 dialogsChatIconFgOver: dialogsNameFgOver; // chat list group or channel icon with mouse over
 dialogsDateFgOver: #ffffff; // chat list date text with mouse over
 dialogsTextFgOver: #ffffff; // chat list message text with mouse over
