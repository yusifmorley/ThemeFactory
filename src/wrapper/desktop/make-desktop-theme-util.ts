...
export default async function makeThemeDesktop(colorArray,bgbase64,str0="",str2="") {
        ...
        if (str0==="theme-Light") {
            ...
            primaryBG = BGColor;
            const primaryBGTrans = primaryBG + 'cc';
            primaryBG2 = ColorLuminance(primaryBG, 0.15);
            primaryBG3 = ColorLuminance(primaryBG2, 0.15);
            primaryBG4 = ColorLuminance(primaryBG3, 0.15);
            primaryBG4Trans = primaryBG4Trans + 'd4';
            primaryBG5 = ColorLuminance(primaryBG4, 0.15);
            primaryBG6 = ColorLuminance(primaryBG5, 0.15);
            primaryText = invertColor(primaryBG);
            primaryText2 = invertColor(primaryBG2);
           const primaryText3 = invertColor(primaryBG3);
        ...
        Palette = Palette + `windowBg: primaryDark; // white: fallback for background
