...
const tgiosVariables = (name, colors) => {
    const { background, filling, themeIsLight, primary, secondaryText, text, textOnPrimary, bubbleOutColor: outgoingBubbleBackground, } = helpers_1.themeData(colors);
    const template = `
name: ${name}
basedOn: day
dark: ${!themeIsLight}
...
exports.default = tgiosVariables;
